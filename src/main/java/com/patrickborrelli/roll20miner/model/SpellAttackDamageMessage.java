...
public class SpellAttackDamageMessage extends Message {
	...
	private static final Logger LOGGER = LogManager.getLogger(SpellAttackDamageMessage.class);
			...
			if(sheetAttack != null) {
				if(sheetAttack.hasClass(MinerUtil.SHEET_SAVE)) {
					...
					if(soloRoll != null) {
						...
						builder.append("Casting ").append(labelText.text());		
	...
	public String toCsvString() {
		...
		builder.append(super.toCsvString("Spell"));		
